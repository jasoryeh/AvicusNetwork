 ...
 * <p>
 * Where T is the CommandSender type.
 */
public abstract class AvicusCommandsManager<T> extends CommandsManager<T> {

    /**
     * Where T is the CommandSender in your distribution of Bungee or Bukkit
     *
     ...
     */
    @Override
    public abstract boolean hasPermission(T sender, String perm);
