...
public final class DamageAPIHelper {
    ...
    private final
    @Nonnull
    Map<org.bukkit.event.entity.EntityDamageEvent, EntityDamageEvent> eventMapping = Maps
            .newHashMap();
     ...
     * @param damage Damage info that describes the damage or null to clear the store information
     * @return Previous damage info associated with the event
     * @throws NullPointerException if event is null
     */
    public
    @Nullable
    DamageInfo setEventDamageInfo(@Nonnull org.bukkit.event.entity.EntityDamageEvent event,
                                  @Nullable DamageInfo info) {
        Preconditions.checkNotNull(event, "entity damage event");
    ...
    public
    @Nullable
    EntityDamageEvent setOurEvent(@Nonnull org.bukkit.event.entity.EntityDamageEvent bukkit,
                                  @Nullable EntityDamageEvent our) {
        Preconditions.checkNotNull(bukkit, "entity damage event");
