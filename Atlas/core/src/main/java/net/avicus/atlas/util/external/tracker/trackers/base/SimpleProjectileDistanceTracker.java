...
public class SimpleProjectileDistanceTracker extends AbstractTracker implements
    ...
    public void clear(World world) {
        ...
        Iterator<Map.Entry<Projectile, Location>> projectileIt = this.projectileLaunchLocations
                .entrySet().iterator();
