package net.avicus.atlas.util.external.tracker.trackers.base;

import com.google.common.base.Preconditions;
import com.google.common.collect.Maps;
import net.avicus.atlas.util.external.tracker.base.AbstractTracker;
import net.avicus.atlas.util.external.tracker.trackers.AnvilTracker;
...
public class SimpleAnvilTracker extends AbstractTracker implements AnvilTracker {
    ...
    @Nullable
    public OfflinePlayer setOwner(@Nonnull FallingBlock anvil,
    ...
    public void clear(@Nonnull World world) {
        ...
        Iterator<Map.Entry<FallingBlock, OfflinePlayer>> entityIt = this.ownedAnvils.entrySet()
                .iterator();
