...
import net.avicus.atlas.util.tablist.Tabbed;
import net.avicus.atlas.util.tablist.item.BlankTabItem;
import net.avicus.atlas.util.tablist.item.PlayerTabItem;
import net.avicus.atlas.util.tablist.item.TabItem;
import net.avicus.atlas.util.tablist.item.TextTabItem;
import net.avicus.atlas.util.tablist.tablist.TabList;
import net.avicus.atlas.util.tablist.tablist.TableTabList;
import net.avicus.atlas.util.tablist.tablist.TableTabList.FillDirection;
import net.avicus.atlas.util.tablist.tablist.TableTabList.TableBox;
