...
import net.avicus.libraries.tabbed.Tabbed;
import net.avicus.libraries.tabbed.item.BlankTabItem;
import net.avicus.libraries.tabbed.item.PlayerTabItem;
import net.avicus.libraries.tabbed.item.TabItem;
import net.avicus.libraries.tabbed.item.TextTabItem;
import net.avicus.libraries.tabbed.tablist.TabList;
import net.avicus.libraries.tabbed.tablist.TableTabList;
import net.avicus.libraries.tabbed.tablist.TableTabList.FillDirection;
import net.avicus.libraries.tabbed.tablist.TableTabList.TableBox;
import net.avicus.libraries.tabbed.tablist.TableTabList.TableCell;
import net.avicus.libraries.tabbed.tablist.TableTabList.TableCorner;
