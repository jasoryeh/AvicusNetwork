...
public class CaptureAreaScoreCompleteEvent extends ObjectiveCompleteEvent {
    ...
    public CaptureAreaScoreCompleteEvent(CaptureAreaObjective captureArea, Player player) {
