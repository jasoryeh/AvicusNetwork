package net.avicus.atlas.sets.competitive.objectives;
...
import net.avicus.atlas.sets.competitive.objectives.listeners.RewardAndTrackingListeners;
import net.avicus.atlas.sets.competitive.objectives.listeners.SoundListener;
import net.avicus.atlas.sets.competitive.objectives.bridges.GroupsBridge.FFABridge;
import net.avicus.atlas.sets.competitive.objectives.bridges.GroupsBridge.TeamsBridge;
import net.avicus.atlas.sets.competitive.objectives.bridges.ObjectivesBridge;
import net.avicus.atlas.sets.competitive.objectives.bridges.ResultsBridge;
import net.avicus.atlas.sets.competitive.objectives.bridges.SBHook;
import net.avicus.atlas.sets.competitive.objectives.bridges.StatsBridge;
import net.avicus.atlas.sets.competitive.objectives.destroyable.DestroyableFactory;
...
import net.avicus.atlas.sets.competitive.objectives.flag.FlagFactory;
...
import net.avicus.atlas.sets.competitive.objectives.hill.HillFactory;
...
import net.avicus.atlas.sets.competitive.objectives.phases.PhasesFactory;
import net.avicus.atlas.sets.competitive.objectives.wool.WoolFactory;
...
import net.avicus.atlas.sets.competitive.objectives.zones.ZonesParsingBridge;
...
public class Main extends ModuleSet {
    ...
    public void onEnable() {
        ...
        registerRewardAndTrackingListeners();
        addFactories();
    ...
    private void registerRewardAndTrackingListeners() {
        // requires hook
        // todo: don't require hook.
        try {
            Class.forName("net.avicus.hook.Hook");

            RewardAndTrackingListeners.register();
        } catch(ClassNotFoundException e) {
            this.logger.info("The Hook plugin was not found, competitive rewards will not be enabled.");
        }
    }
