...
import net.avicus.atlas.sets.competitive.objectives.actions.wool.PlayerPlaceWoolAction;
import net.avicus.atlas.sets.competitive.objectives.destroyable.leakable.event.LeakableLeakEvent;
import net.avicus.atlas.sets.competitive.objectives.actions.destroyable.base.PlayerDamageDestoyableAction;
import net.avicus.atlas.sets.competitive.objectives.actions.destroyable.base.PlayerRepairDestoyableAction;
import net.avicus.atlas.sets.competitive.objectives.actions.destroyable.leakable.PlayerLeakLeakableAction;
import net.avicus.atlas.sets.competitive.objectives.actions.destroyable.monument.PlayerDestroyMonumentAction;
import net.avicus.atlas.sets.competitive.objectives.actions.flag.PlayerCaptureFlagAction;
import net.avicus.atlas.sets.competitive.objectives.actions.flag.PlayerDropFlagAction;
import net.avicus.atlas.sets.competitive.objectives.actions.flag.PlayerPickupFlagAction;
import net.avicus.atlas.sets.competitive.objectives.actions.hill.CompetitorCaptureHillAction;
import net.avicus.atlas.sets.competitive.objectives.actions.hill.PlayerCaptureHillAssistAction;
import net.avicus.atlas.sets.competitive.objectives.actions.wool.PlayerTouchWoolAction;
